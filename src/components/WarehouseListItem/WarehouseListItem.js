  ...
  return (
    <li className="warehouse">
      ...
      >
        <div>
          <div className="delete-modal__icon-container">
            <img className="delete-modal__icon" src={closeIcon} alt="cancel" onClick={this.handleCloseModal.bind(this)}/>
          </div>
          <div className="delete-modal__text-container">
            <h2 className="delete-modal__title">Delete {this.props.name} warehouse?</h2>
            <p className="delete-modal__text">
              Please confirm that you’d like to delete the {this.props.name} warehouse from the list of warehouses. You won’t be able to undo this action.
            </p>
          </div>
        </div>
          ...
          <div className="warehouse__info-container">
            ...
            <div className="warehouse__link">
              <Link to={`/warehouse/${this.props.id}`}>
                <p className="warehouse__info warehouse__info--link">{this.props.name}</p>
              </Link>
              <img
      ...
      <div className="warehouse__icon-container">
        <img className="warehouse__icon" src={deleteIcon} alt="delete" onClick={this.handleOpenModal.bind(this)}/>
        <Link className="warehouse__icon-link" to={`/warehouse/edit/${this.props.id}`}>
