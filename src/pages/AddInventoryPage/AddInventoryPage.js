...
class AddInventoryPage extends Component {
  ...
  handleStatusChange = (e) => {
    if (e.target.value === "Out of Stock") {
      this.setState({
        quantityStyle:
          "new-inventory__quantity-container new-inventory__quantity-container--display",
        status: "Out of Stock",
        quantity: 0,
      });
          ...
          <form onSubmit={this.handleSubmit} className="new-inventory__form">
              ...
              <div className="new-inventory__details">
                ...
                <div className="new-inventory__radio-container">
                  <div className="new-inventory__radio">
                    ...
                    />
                    <label
                      className="new-inventory__radio-text"
                      htmlFor="in_stock"
                    >
                      In stock
                    </label>
                ...
                <div className={this.state.quantityStyle}>
                  <label className="new-inventory__label" htmlFor="quantity">
                    Quantity
                  </label>
                  <input
                    className="new-inventory__input"
            ...
            <div className="new-inventory__button-container">
              <Link to={"/inventory"} className="new-inventory__button-link">
                <button className="new-inventory__button new-inventory__button--cancel">
                  Cancel
                </button>
              </Link>
              <button type="submit" className="new-inventory__button">
                + Add Item
              </button>
            </div>
          </form>
